...
def parse_args():
    ...
    parser.add_argument("-s", "--start", metavar="", help="Start string in the form 2019-06-23")
    parser.add_argument("-e", "--end", metavar="", help="End string in the form 2019-06-23")
    global args 
